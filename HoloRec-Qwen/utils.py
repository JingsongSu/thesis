...
def parse_global_args(parser):
    ...
    parser.add_argument("--base_model", type=str,
                        default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/llama-7b",
...
def parse_dataset_args(parser):
    parser.add_argument("--data_path", type=str, default="./data",
                        help="data directory")
    parser.add_argument("--tasks", type=str, default="seqrec,item2index,index2item",
    ...
    parser.add_argument("--only_train_response", action="store_true", default=True,
                        help="whether only train on responses")

    parser.add_argument("--train_prompt_sample_num", type=str, default="1,1,1",
                        help="the number of sampling prompts for each task")
    parser.add_argument("--train_data_sample_num", type=str, default="0,0,0",
                        help="the number of sampling prompts for each task")
