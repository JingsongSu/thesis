...
def parse_args():
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/RQ-VAE-notw/checkpoint-Yelp/epoch_9999_collision_0.0591_model.pth",
        help="root path",
    )
    parser.add_argument(
        "--output_file",
        type=str,
        default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/RQ-VAE-notw/sid-Yelp/nq_sid_tw_rqvae.json",
...
for d, doc_ids in tqdm(data_loader):
    ...
    for doc_id, index in zip(doc_ids, indices):
        code = []
        for ind in index:
        ...
        sid_str = "-".join(code)
        sid_to_sku[sid_str].append(str(doc_id))


with open(output_file, "w", encoding="utf-8") as file:
    json.dump(sid_to_sku, file, ensure_ascii=False, indent=4)
