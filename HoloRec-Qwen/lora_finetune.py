...
#     # ===== 4) 加载模型 =====
#     # 说明：新版 transformers 里 torch_dtype 被提示 deprecated，改用 dtype
...
#         dtype=dtype,  # ✅ 用 dtype 替代 torch_dtype
#         trust_remote_code=True,
#         attn_implementation="flash_attention_2",  # 没装 flash-attn 会自动回退
#     )

#     # 你 add 了新 token，需要 resize
#     model.resize_token_embeddings(len(tokenizer))
