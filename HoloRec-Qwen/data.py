...
#             last_pos = len(self.allowed_tokens.keys())
#             self.allowed_tokens[last_pos] = set([tokenizer.eos_token_id])

#         # 兜底：如果没传 prompt_len，就用第一次 seen 的长度（不推荐但保留）
#         seen_prompt_len = {}
