...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="/home/yaoxingzhi1/paper/dataset/NQ320k/filtered_id_emb_data.pkl", help="Input data path.")
    ...
    parser.add_argument("--log_file_path", type=str, default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/RQ-VAE-notw/logs/taowa_0612_main_gpu_Instruments.log")
    parser.add_argument("--ckpt_dir", type=str, default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/RQ-VAE-notw/checkpoint-Instruments", help="output directory for model")
