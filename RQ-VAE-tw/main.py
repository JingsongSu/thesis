...
def parse_args():
    ...
    parser.add_argument("--log_file_path", type=str, default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/RQ-VAE/logs/taowa_0612_main_gpu.log")
    parser.add_argument("--ckpt_dir", type=str, default="/home/jovyan/ceph-1/sujinsong/sujinsong/thesis/LETTER-master/RQ-VAE-tw/checkpoint", help="output directory for model")
